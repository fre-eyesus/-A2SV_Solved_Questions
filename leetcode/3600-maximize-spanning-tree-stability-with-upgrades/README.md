...
**Problem:** [Maximize-Spanning-Tree-Stability-with-Upgrades](https://leetcode.com/problems/maximize-spanning-tree-stability-with-upgrades)
...
Example 1:**Input:** n = 3, edges = [[0,1,2,1],[1,2,3,0]], k = 1
